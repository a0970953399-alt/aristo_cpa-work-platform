...
export const WorkCheckIn: React.FC<{ onClose: () => void }> = ({ onClose }) => {
    ...
    const handleClockIn = () => {
        ...
        // 🔔 發送通知給主管
        NotificationService.send('工讀生A', 'CLOCK_IN');
    ...
    const handleClockOut = () => {
        ...
        // 🔔 發送審核請求給主管
        NotificationService.send('工讀生A', 'CLOCK_OUT');
    ...
    const handleApprove = (logId: string) => {
        ...
        // 可以在這裡清除通知，不過為了保留紀錄，我們通常只改狀態
        // 這裡簡單處理：直接把對應的通知標記為已讀
        // (實際專案會需要對應 ID，這裡先用簡單邏輯)
    };
    ...
    return (
        <div className="fixed inset-0 bg-gray-100 z-[100] overflow-auto animate-fade-in">
            {/* 頂部導航列 */}
                        ...
                        <div className="bg-white p-8 rounded-2xl shadow-sm text-center">
                            ...
                            <div className="flex justify-center gap-8">
                                <button 
                                    ...
                                    className="w-40 h-40 rounded-full bg-green-500 hover:bg-green-600 text-white font-bold text-xl shadow-lg hover:shadow-xl transition-all flex flex-col items-center justify-center gap-2 transform active:scale-95"
                                >
                                ...
                                <button 
                                    ...
                                    className="w-40 h-40 rounded-full bg-orange-400 hover:bg-orange-500 text-white font-bold text-xl shadow-lg hover:shadow-xl transition-all flex flex-col items-center justify-center gap-2 transform active:scale-95"
                                >
