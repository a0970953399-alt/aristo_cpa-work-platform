                                            ...
                                            return (
                                                ...
                                                >
                                                    {hoveredMultiCell === cellKey && hours > 0 && (
                                                        <span className="text-[9px] font-bold text-blue-600 leading-none">{hours}</span>
                                                    )}
                                                </div>
                                            );
                                        })}
                                    ...
                                    <div key={wi} className="grid grid-cols-7 gap-1.5 mb-1.5">
                                        {week.map((day, di) => {
                                            ...
                                            return (
                                                ...
                                                >
                                                    <span className={`text-base font-bold drop-shadow-sm ${hoveredDate === dateStr && hours > 0 ? 'text-blue-600' : 'text-gray-800'}`}>
